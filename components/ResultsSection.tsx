  ...
  return (
    <div className="space-y-6">
      ...
      <div className="print-header">
        <h1 className="text-2xl font-bold">{t.appTitle} - {t.resultsTitle}</h1>
        <p className="text-sm text-gray-600 mt-2">
          {t.monthlyContribution}: {formatCurrency(state.monthlyContribution)} | {t.duration}: {state.years} {t.yearsSuffix} | {state.mode === 'fixed' ? `${t.fixedRate} (${state.annualReturn}%)` : t.historicalBacktest}
        </p>
      </div>
